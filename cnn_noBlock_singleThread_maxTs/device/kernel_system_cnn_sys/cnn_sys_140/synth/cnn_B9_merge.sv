...
// SystemVerilog created from cnn_B9_merge
...
module cnn_B9_merge (
    ...
    // out_add1788_push36760(GPOUT,9)
    assign out_add1788_push36760 = in_add1788_push36760_0;

    // out_add3193_push37765(GPOUT,10)
    assign out_add3193_push37765 = in_add3193_push37765_0;

    // out_add82_push35755(GPOUT,11)
    assign out_add82_push35755 = in_add82_push35755_0;

    // out_notcmp71106_pop42770(GPOUT,12)
    assign out_notcmp71106_pop42770 = in_notcmp71106_pop42770_0;

    // out_notcmp75102_pop40768(GPOUT,13)
    assign out_notcmp75102_pop40768 = in_notcmp75102_pop40768_0;
