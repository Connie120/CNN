...
// SystemVerilog created from cnn_B3_branch
...
module cnn_B3_branch (
    ...
    // out_add1789(GPOUT,7)
    assign out_add1789 = in_add1789;

    // out_add83(GPOUT,8)
    assign out_add83 = in_add83;

    // out_c0_exe1799(GPOUT,9)
    assign out_c0_exe1799 = in_c0_exe1799;
