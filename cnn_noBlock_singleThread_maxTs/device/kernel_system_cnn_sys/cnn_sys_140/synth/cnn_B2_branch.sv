...
// SystemVerilog created from cnn_B2_branch
...
module cnn_B2_branch (
    input wire [63:0] in_add84,
    input wire [63:0] in_c0_exe1787,
    ...
    // out_add84(GPOUT,6)
    assign out_add84 = in_add84;

    // out_c0_exe1787(GPOUT,7)
    assign out_c0_exe1787 = in_c0_exe1787;
