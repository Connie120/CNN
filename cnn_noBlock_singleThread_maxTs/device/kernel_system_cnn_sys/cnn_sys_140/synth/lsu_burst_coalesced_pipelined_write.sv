...
//    Maybe have a MAX_THREADS and MIN_THREADS, and if > MIN and starting a new word, then end the burst?
   ...
   localparam                    FIFO_STYLE = "hs";                                          // 
   localparam                    FIFO_WRITE_TO_EMPTY_LATENCY = 5;                            // use 5 for high speed fifo, 3 for mid speed fifo
   ...
   (
      ...
      .i_data                       ({writedata_cpipe[COALESCER_PIPE_DEPTH], byteenable_cpipe[COALESCER_PIPE_DEPTH]}),
